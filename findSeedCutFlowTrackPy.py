...
histos =  {'hSVDValues2Global': TH1D("hSVDValues2Global", "output of SVD[1]; fit quality [1]; Events", 200, 0, 0.3), 
           ...
           'hNminus1Py_Low_Multiplicity_EGt4_TightTracks': TH1D('hNminus1Py_Low_Multiplicity_EGt4_TightTracks', "track p_{Y}, low multiplicity, E > 4, tight tracks; p'_Y [GeV]; Entries",100, -0.06, 0.06),
           'hNminus1Py_Low_Multiplicity_EGt4_LooseTracks': TH1D('hNminus1Py_Low_Multiplicity_EGt4_LooseTracks', "track p_{Y}, low multiplicity, E > 4, loose tracks; p'_Y [GeV]; Entries",100, -0.07, 0.07),
...
def main():
    ...
    parser.add_argument('-m', action="store", dest="nminus1Str", type=str, default="trackPyNminus1")  ### distancedNminus1, SVDParNminus1
